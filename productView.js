...
function displayProd(prodDetailsArr){
    ...
    prodDetailsArr.forEach(function(ele,i){
        ...
        img.image.src= ele.Image;
        img.addEventListener("click", function(){
            let image = document.createElement("img")
            image.image.src= ele.Image;
        })

        let img1 = document.createElement("img")
        img1.image.src= ele.Image1;
        img1.addEventListener("click", function(){
            let image = document.createElement("img")
            image.image.src= ele.Image1;
        })

        let img2 = document.createElement("img")
        img2.image.src= ele.Image2;
        img2.addEventListener("click", function(){
            let image = document.createElement("img")
            image.image.src= ele.Image2;
        })
