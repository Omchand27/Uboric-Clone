let ShopData = [
    ...
    {
      Name: "Reebok Men’s Port Line Running Shoe",
      Price: "₹2,799.00",
      totprice: 2799,
      Image:
    ...
    {
      Name: "Reebok Men’s Energy Runner 2.0 Running Shoe",
      Price: "₹2,299.00",
      totprice: 2299,
      Image:
    ...
    {
      Name: "Reebok Men’s Austin Running Shoe",
      Price: "₹2,099.00",
      totprice: 2099,
      Image:
    ...
    {
      Name: "Plastic Organic Hygienic Fresh Sprout Maker Box Sprouted Jar with 3 Container for Home, (2 Container)",
      Price: "₹219.00",
      totprice: 219,
      Image:
    ...
    {
      Name: "Sprout Maker | Crystal Clear Transparent (Medium)",
      Price: "₹298.00",
      totprice: 298,
      Image:
    ...
    {
      Name: "Sprout Maker Fresh Sprouts with 4 Compartment (Big)",
      Price: "₹339.00",
      totprice: 339,
      Image:
    ...
    {
      Name: "GRECY JANTA Glass 6 Pcs Plastic Unbreakable Stylish Transparent Water Glass/Juice Glass/Beer Glass/Wine Glass Plastic Glass Set ( 250 ML, Pack of 6) (JANTA Glass)",
      Price: "₹125.00",
      totprice: 125,
      Image:
    ...
    {
      Name: "4 in 1 Multipurpose Plastic 2 Spice and 2 Pickle, Achar Container Set for Dining Table with Spoon",
      Price: "₹198.00",
      totprice: 198,
      Image:
    ...
    {
      Name: "Camera Lens Plastic Coffee Mug with 2 Lid, 400ml, Black",
      Price: "₹345.00",
      totprice: 345,
      Image:
    ...
    {
      Name: "Plastic LPG Gas Cylinder Trolley Easily Movable Stand with Wheels Flower Pot Stand Use As Carrying Kitchen Items Up To 75 kg (Red)",
      Price: "₹289.00",
      totprice: 289,
      Image:
    ...
    {
      Name: "STUFF COOL Plastic Gadget Adjustable Slicer – (Black)",
      Price: "₹169.00",
      totprice: 169,
      Image:
    ...
    {
      Name: "Titanic 7 Section Masala Box, 700ml Masala Container For Kitchen, Multipurpose Masala and Rangoli box, Airtight Masala Storage Container (Titanic Masala Box)",
      Price: "₹189.00",
      totprice: 189,
      Image:
    ...
    {
      Name: "Cake Palette Knife | Steel Icing Spatula 3 Pieces Set | Cake Knife | Cream Icing Frosting Spatula | Baking Kitchen Pastry Cake Decoration Tool. (4.5, 3 Pieces Set)",
      Price: "₹79.00",
      totprice: 79,
      Image:
    ...
    {
      Name: "Pyramid Stylish Modern Look Water Bottle Set of 3-1000ml capacity fridge/daily uses Office School Collage Travel (Spiral Water Bottle 1 Ltr)",
      Price: "₹350.00",
      totprice: 350,
      Image:
    ...
    {
      Name: "Stainless Steel 4 in 1 Slicer and Grater Chopper Fruit Slicer Dicer Grater Potatoes Slicer Peeler Attach 4 Blades for Chips Vegetable & Fruit Cutter Slicer Vegetable Slicer for Kitchen",
      Price: "₹149.00",
      totprice: 149,
      Image:
    ...
    {
      Name: "3 in 1 Large Durable Plastic Kitchen Sink Dish Rack Drainer Drying Rack Washing Basket with Tray for Kitchen, Dish Rack Organizers, Utensils Tools Cutlery (Brown)",
      Price: "₹409.00",
      totprice: 409,
      Image:
    ...
    {
      Name: "Grecy Plastic Manual Easy Power-Free Hand Blender Beater, Liquidizer, Churner for Cream, Eggs, Soup, Dal, Lassi, Milkshake with High-Speed Operation (Multicolor)",
      Price: "₹248.00",
      totprice: 248,
      Image:
    ...
    {
      Name: "Home Plus Hand Juicer | Orange Juicer with Strainer | Heavy Duty Aluminium Alloy | Manual Juicer",
      Price: "₹670.00",
      totprice: 670,
      Image:
    ...
    {
      Name: "Yellow Full Cotton Patiala Salwar",
      Price: "₹499.00",
      totprice: 499,
      Image:
    ...
    {
      Name: "Anti Puncture Tyre Sealant – Special...",
      Price: "₹699.00",
      totprice: 699,
      Image:
    ...
    {
      Name: "Hepo Economic Drawer Lock (Psc 10)",
      Price: "₹1,080.00",
      totprice: 1080,
      Image:
    ...
    {
      Name: "Hepo SS 450 mm Bathroom Towel Rack",
      Price: "₹2,095.00",
      totprice: 2095,
      Image:
    ...
    {
      Name: "Hepo SS 350 mm Bathroom Towel Rail (Psc-1)",
      Price: "₹725.00",
      totprice: 725,
      Image:
    ...
    {
      Name: "Hepo SS Soap & Shampoo Holder (Psc-1)",
      Price: "₹948.00",
      totprice: 948,
      Image:
    ...
    {
      Name: "Hepo SS Tooth Brush Holder (Psc-1)",
      Price: "₹757.00",
      totprice: 757,
      Image:
    ...
    {
      Name: "Hepo SS Bathroom Clothes Hook (Psc-1)",
      Price: "₹1,138.00",
      totprice: 1138,
      Image:
    ...
    {
      Name: "Hepo SS Accessory Shelf (Psc-1)",
      Price: "₹1,043.00",
      totprice: 1043,
      Image:
    ...
    {
      Name: "Hepo SS Hand Towel Holder (Psc-1)",
      Price: "₹485.00",
      totprice: 485,
      Image:
    ...
    {
      Name: "FINACHI Ultra Soft Inner Boxer Black",
      Price: "₹325.00",
      totprice: 325,
      Image:
    ...
    {
      Name: "FINACHI Ultra Soft Inner Boxer Grey",
      Price: "₹325.00",
      totprice: 325,
      Image:
    ...
    {
      Name: "FINACHI Ultra Soft Inner Boxer Magenta",
      Price: "₹325.00",
      totprice: 325,
      Image:
    ...
    {
      Name: "FINACHI Ultra Soft Inner Boxer Navy Blue",
      Price: "₹325.00",
      totprice: 325,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi color in black",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi color in yellow",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi color in navy",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi colour in green",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi colour in white",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Men shirt magic cotton with digital print in multi colour in black",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Tomato Cotton Printed Long Tunic",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Brown Cotton Printed Long Tunic for Work Wear",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "White Anarkali Cotton Printed Long Tunic...",
      Price: "₹985.00",
      totprice: 985,
      Image:
    ...
    {
      Name: "Yellow Cotton Printed Long Tunic for Work...",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Dark Blue Cotton Printed Long Tunic for Work...",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Cotton Printed Long Tunic for Work Wear",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Tomato Cotton Printed Long Tunic for Work...",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Turquoise Cotton Printed Long Tunic for Work...",
      Price: "₹795.00",
      totprice: 795,
      Image:
    ...
    {
      Name: "Duracable 1.2M Cable (C-Type)",
      Price: "₹399.00",
      totprice: 399,
      Image:
    ...
    {
      Name: "Nector Bluetooth Stereo Neckband",
      Price: "₹1,999.00",
      totprice: 1999,
      Image:
    ...
    {
      Name: "Powerbuds Sweat Proof TWS",
      Price: "₹3,499.00",
      totprice: 3499,
      Image:
    ...
    {
      Name: "Aquaboom Portable Speaker",
      Price: "₹1,399.00",
      totprice: 1399,
      Image:
    ...
    {
      Name: "Ambrane Pulse Full Touch Control Smart Watch (Black)",
      Price: "₹2,999.00",
      totprice: 2999,
      Image:
    ...
    {
      Name: "Qor9 pro Bluetooth Calling Smartwatch with 1.69” full touch screen ,Multiple Watch Faces & thin design heart rate detection",
      Price: "₹1,999.00",
      totprice: 1999,
      Image:
    ...
    {
      Name: "all 14 pack of diffrent pepriqua ready to cook 100 gm",
      Price: "₹1,099.00",
      totprice: 1099,
      Image:
    ...
    {
      Name: "all 19 pack of diffrent pepriqua instant mix 400gm",
      Price: "₹1,935.00",
      totprice: 1935,
      Image:
    ...
    {
      Name: "20 pack of pepriqua ready to cook veg kadai 50gm",
      Price: "₹799.00",
      totprice: 799,
      Image:
    ...
    {
      Name: "20 pack of pepriqua ready to cook tandoori masala 50gm",
      Price: "₹799.00",
      totprice: 799,
      Image:
    ...
    {
      Name: "20 pack of pepriqua ready to cook super garam masala 50gm",
      Price: "₹699.00",
      totprice: 699,
      Image:
    ...
    {
      Name: "20 pack of pepriqua ready to cook shahi paneer 50gm",
      Price: "₹799.00",
      totprice: 799,
      Image:
        "https://img.freepik.com/free-vector/purchasing-habits-abstract-concept-vector-illustration-generate-consumer-habit-marketing-research-millennial-purchasing-preference-shopping-habitual-buying-behavior-abstract-metaphor_335657-2881.jpg?w=740&t=st=1677348261~exp=1677348861~hmac=e52506b0979e380e233bf0168ff462a26ae9d19a9c6e33289e0b5e94b2e38243" ||"https://outstripinfotech.com/wpword/razi/wp-content/uploads/2022/08/Shahi-Paneer.png",
    ...
    {
      Name: "Primelife 6 pcs DIY Plastic Grid Drawer Divider Household Storage Strips-Large – Made In India (DD – Multicolor)",
      Price: "₹199.00",
      totprice: 199,
      Image:
    ...
    {
      Name: "Risentshop Silicone Toilet Brush with Holder Stand , Brush for Bathroom Cleaning, Cleaning Silicone Brush and Holder (Multi Color, Pack of 1)",
      Price: "₹389.00",
      totprice: 389,
      Image:
    ...
    {
      Name: "Shopiable Store Portable Toothbrush, Tongue Cleaner Holder Case Traveling, Outdoor, Use to Storage & Carry Case Storage Box Cover Organizer (3)",
      Price: "₹249.00",
      totprice: 249,
      Image:
    ...
    {
      Name: "iLife Velway V8s Smart robotic Vacuum Cleaner with High Suction with WiFi Connected Compatible with Alexa and Google Home , Mapping and Ultra Power Navigation White",
      Price: "₹29,999.00",
      totprice: 29999,
      Image:
    ...
    {
      Name: "Amour V7s 3-in-1 Smart robotic Vacuum Cleaner WiFi Connected Compatible with Alexa and Google Home",
      Price: "₹24,999.00",
      totprice: 24999,
      Image:
    ...
    {
      Name: "7.5HP SS Pack Body 2 In 1 Pulverizer",
      Price: "₹97,750.00",
      totprice: 97750,
      Image:
    ...
    {
      Name: "1.25 HP SS Baby Portable Flour Mill",
    ...
    {
      Name: "Daniel Christian The Millenary (Silver)",
      Price: "₹6,599.00",
      totprice: 6599,
      Image:
    ...
    {
      Name: "Daniel Christian The Millenary (black)",
      Price: "₹6,990.00",
      totprice: 6990,
      Image:
    ...
    {
      Name: "Daniel Christian The Ghost (Red)",
      Price: "₹7,950.00",
      totprice: 7950,
      Image:
  ...
  function display(ShopData) {
    ...
    ShopData.forEach(function (el) {
      ...
      totprice.innerText = el.totprice || "";
  ...
  let priceselected = document.querySelector("#mangal")
  // console.log(priceselected);
   
  priceselected.addEventListener("change", function (){
   
      if(document.querySelector("#mangal").value === "low to high"){
          let newData = ShopData.sort(function(a,b){
              return a.totprice - b.totprice;
          })
          display(newData);
   
      }else if (document.querySelector("#mangal").value === "high to low"){
          let newData = ShopData.sort(function(a,b){
              return b.totprice - a.totprice;
          })
          display(newData);
         
      }else if(document.querySelector("#mangal").value === "Grocery"){
          let newData = ShopData.filter(function(ele, i){
            return ele.Categories === "Grocery"
          })
          display(newData);
   
      }else if(document.querySelector("#mangal").value === "Men's fashion"){
        let newData = ShopData.filter(function(ele, i){
          return ele.Categories === "Men's fashion"
        })
        display(newData);
      }else if(document.querySelector("#mangal").value === "Women's Fashion"){
        let newData = ShopData.filter(function(ele, i){
          return ele.Categories === "Women's Fashion"
        })
        display(newData);
      }
  })
